    ...
    Properties{
        ...
        SubShader{
            ...
            fixed4 frag(v2f i) : SV_Target{
                ...
                fixed halfLambert = dot(worldNormal, worldLightDir) * 0.5 + 0.5;// 半兰伯特使用到的参数

                fixed3 diffuse = _LightColor0.rgb * _Diffuse.rgb * halfLambert; // 半兰伯特公式，计算出射的漫反射光线
